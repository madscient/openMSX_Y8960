...
# メモリマップド I/O のトンネル 7FEAh/7FEBh (SSGS) と 7FF0h/7FF1h (DCSG) の
# 回帰テスト。b0/b1 (OPL2) と b4 (SSGS) は別のテストで見ている。
#
...
proc run_test {} {
	...
	report "6. 7FFF=00, tunnel 7FF0h/7FF1h (expect 7 8)"

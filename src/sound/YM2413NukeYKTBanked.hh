...
#ifndef YM2413NUKEYKTBANKED_HH
#define YM2413NUKEYKTBANKED_HH
...
namespace openmsx::YM2413NukeYKTBanked {
...
private:
	...
	Patch* getPatchPtr(uint8_t num);

private:
	static const std::array<Patch, 15*4> m_patches;
	...
	uint8_t rhythm;
	uint8_t testMode;
	std::array<Patch, 1 + 15 * 4> patches; // user patch (modifiable) + 15 ROM patches
